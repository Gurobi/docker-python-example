...
* [10.0.3, latest](https://github.com/Gurobi/docker-python-example/blob/master/10.0.3/Dockerfile)
* [10.0.2, latest](https://github.com/Gurobi/docker-python-example/blob/master/10.0.2/Dockerfile)  
...
- The [Dockerfile](https://github.com/Gurobi/docker-python-example/blob/master/10.0.3/Dockerfile) shows how to customize the image
- The [code](https://github.com/Gurobi/docker-python-example/blob/master/10.0.3/matrix1.py) in Python sets up the WLS license 
