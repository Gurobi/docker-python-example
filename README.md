...
* [10.0.1, latest](https://github.com/Gurobi/docker-python-example/blob/master/10.0.1/Dockerfile)
...
- The [Dockerfile](https://github.com/Gurobi/docker-python-example/blob/master/10.0.1/Dockerfile) shows how to customize the image
- The [code](https://github.com/Gurobi/docker-python-example/blob/master/10.0.1/matrix1.py) in Python sets up the WLS license 
