...
* [12.0.3, latest](https://github.com/Gurobi/docker-python-example/blob/master/12.0.3/Dockerfile)
* [12.0.2](https://github.com/Gurobi/docker-python-example/blob/master/12.0.2/Dockerfile)
* [12.0.1](https://github.com/Gurobi/docker-python-example/blob/master/12.0.1/Dockerfile)
* [12.0.0](https://github.com/Gurobi/docker-python-example/blob/master/12.0.0/Dockerfile)
* [11.0.3](https://github.com/Gurobi/docker-python-example/blob/master/11.0.3/Dockerfile)
...
- The [Dockerfile](https://github.com/Gurobi/docker-python-example/blob/master/12.0.3/Dockerfile) shows how to customize the image
- The [code](https://github.com/Gurobi/docker-python-example/blob/master/12.0.3/matrix1.py) in Python sets up the WLS license 
